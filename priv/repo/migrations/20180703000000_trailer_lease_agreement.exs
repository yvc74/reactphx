defmodule GW.Repo.Migrations.Web.Models.Trailers.TrailerLeaseAgreement do
    use Ecto.Migration
    ...
    def change do
        create table(:trailer_lease_agreement) do
          ...
          add :lessor_person_id, references(:person, on_delete: :delete_all)
          add :shuttle_fee, :boolean
          add :person_driver_id, references(:person, on_delete: :delete_all)
        ...
        create index(:trailer_lease_agreement, [:lessor_person_id])
        create index(:trailer_lease_agreement, [:person_driver_id])
