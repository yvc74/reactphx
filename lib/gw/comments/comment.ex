...
#         has_many :request_trailer_service, RequestTrailerService, [foreign_key: :request_comment_id]
#         has_many :request_trailer_service, RequestTrailerService, [foreign_key: :trailer_condition_comment_id]
#         has_many :request_trailer_service, RequestTrailerService, [foreign_key: :comment_large_item_id]
